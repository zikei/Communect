...
object MockTestData {
    ...
    private val groupUser7 = GroupUser(UUID.randomUUID().toString(), group1.groupId, user2.userId, user2.userName, user2.nickName, GroupRole.MEDIUM, false, true)
    ...
    private val groupUser9 = GroupUser(UUID.randomUUID().toString(), group1.groupId, user2.userId, user2.userName, user2.nickName, GroupRole.HIGH, true, true)
